 ...
 */
package com.ada.sqlbuilder.dbutils;
...
public class BasicRowProcessor implements RowProcessor {
     ...
     *
     * @see com.ada.sqlbuilder.dbutils.RowProcessor#toArray(java.sql.ResultSet)
     ...
     * @see com.ada.sqlbuilder.dbutils.RowProcessor#toBean(java.sql.ResultSet, java.lang.Class)
     * @see com.ada.sqlbuilder.dbutils.BeanProcessor#toBean(java.sql.ResultSet, java.lang.Class)
     ...
     * @see com.ada.sqlbuilder.dbutils.RowProcessor#toBeanList(java.sql.ResultSet, java.lang.Class)
     * @see com.ada.sqlbuilder.dbutils.BeanProcessor#toBeanList(java.sql.ResultSet, java.lang.Class)
     * @param <T> The type of bean to create
     * @param rs ResultSet that supplies the bean data
     * @param type Class from which to create the bean instance
     * @throws SQLException if a database access error occurs
     ...
     * @see com.ada.sqlbuilder.dbutils.RowProcessor#toMap(java.sql.ResultSet)
